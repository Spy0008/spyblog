            ...
            <Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
                ...
                <Modal.Body>
                    <div className="text-center">
                        <HiOutlineExclamationCircle className="h-14 w-14 text-zinc-600 dark:text-zinc-200 mb-4 mx-auto" />
                        <h3 className="text-orange-400 mb-5 text-lg dark:text-orange-500">Are you sure you want to delete your account? This action is permanent and cannot be undone. If you have any feedback or need assistance, please let us know!</h3>
                        <div className="flex justify-between">
                            <Button className="active:scale-95" color='failure' onClick={handleDeleteUser}>
                                Yes I'm sure
                            </Button>

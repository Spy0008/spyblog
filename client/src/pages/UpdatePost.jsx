...
export default function UpdatePost() {
    ...
    return (
        <div className='p-3 max-w-3xl mx-auto min-h-screen'>
            <h1 className='text-center my-7 text-3xl font-bold'>Update Blog</h1>
            <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                <div className='flex flex-col gap-4 sm:flex-row justify-between'>
                    <TextInput type='text' placeholder='Blog Title' required id='title' className='flex-1' onChange={(e) => {
                ...
                <ReactQuill value={formData.content} theme='snow' placeholder='write blog releted...' required className='mb-12 h-72' onChange={(value) => {
